    ...
    monthlyExpensesChart = new Chart(monthlyExpensesCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: '#4e88ca',
                backgroundColor: 'rgba(78, 136, 202, 0.08)',
                tension: 0.4,
                fill: true,
                borderWidth: 2,
                pointRadius: 3,
                pointBackgroundColor: '#4e88ca'
            }]
        },
        options: {
            responsive: true,
    ...
    personalMonthlyChart = new Chart(personalMonthlyCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: 'rgba(78, 136, 202, 0.7)',
                borderRadius: 8,
                borderSkipped: false
            }]
        },
...
function initInstantSplitCalculator() {
    ...
    function createRoommateEntries() {
        ...
        for (let i = 0; i < numRoommates; i++) {
            ...
            entryDiv.appendChild(expenseLabel);
